package dev.armadillomike.creepig;
...
import dev.armadillomike.creepig.init.CreepigModTabs;
import dev.armadillomike.creepig.init.CreepigModItems;
import dev.armadillomike.creepig.init.CreepigModEntities;

@Mod("creepig")
public class CreepigMod {
	public static final Logger LOGGER = LogManager.getLogger(CreepigMod.class);
	public static final String MODID = "creepig";

	public CreepigMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		CreepigModItems.REGISTRY.register(modEventBus);
		CreepigModEntities.REGISTRY.register(modEventBus);
		CreepigModTabs.REGISTRY.register(modEventBus);
